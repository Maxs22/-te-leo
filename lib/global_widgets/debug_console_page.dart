      ...
      builder: (controller) {
        return Scaffold(
          ...
          floatingActionButton: Obx(() => FloatingActionButton(
            ...
            child: Icon(
              controller.debugService.autoScroll 
                  ? Icons.pause 
                  : Icons.play_arrow,
            ),
            tooltip: controller.debugService.autoScroll 
                ? 'Pausar auto-scroll' 
                : 'Activar auto-scroll',
          )),
        );
      ...
      child: Column(
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...LogLevel.values.map((level) => Obx(() => Padding(
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: Obx(() => controller.debugService.searchFilter.isNotEmpty
              ? IconButton(
  ...
  Widget _buildLogsList(DebugConsoleController controller) {
    return Obx(() {
      ...
      if (filteredLogs.isEmpty) {
        return const Center(
          child: Text('No hay logs que mostrar'),
        );
      }
...
class DebugConsoleController extends GetxController {
  final DebugConsoleService debugService = Get.find<DebugConsoleService>();
